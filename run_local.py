    ...
    ENV_FILE.write_text(
        "\n".join(
            [
                ...
                "CROSSREF_MAILTO=",
                "CORE_API_KEY=",
                "# --- Check modules (tahlil sahifasida yoqiladi/o'chiriladi) ---",
                "DEFAULT_CHECK_MODULES=corpus,own,ojs,translation,templates",
                "SCHOLARLY_SOURCES=openalex,crossref,semanticscholar,core,arxiv",
                "SEMANTIC_SCHOLAR_API_KEY=",
                "# Patents: free token for scholarly use at https://www.lens.org/lens/user/subscriptions",
                "LENS_API_TOKEN=",
                "# Extra standard phrases not counted as borrowing, separated by |",
                "TEMPLATE_PHRASES=",
                "# Re-harvest HARVEST_OJS_URLS automatically every N hours (0 = off)",
                "OJS_AUTO_HARVEST_HOURS=24",
                "",
